 ...
 */
export declare function getToolCullingState<HorzScaleItem>(points: LineToolPoint[], tool: BaseLineTool<HorzScaleItem>, extendOptions?: ExtendOptions, singlePointOrientation?: SinglePointOrientation, cullingInfo?: LineToolCullingInfo, isAreaBased?: boolean): OffScreenState;
