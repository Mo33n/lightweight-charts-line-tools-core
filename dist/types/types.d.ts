 ...
 */
import { LineStyle, Coordinate, Nominal, Logical, IPriceScaleApi, ISeriesPrimitiveAxisView } from 'lightweight-charts';
 ...
 */
export declare enum PaneCursorType {
    Default = "default",
    Crosshair = "crosshair",
    Pointer = "pointer",
    Grabbing = "grabbing",
 ...
 */
export declare class HitTestResult<T> {
    private _data;
    private _type;
...
export interface IPriceAxisViewRenderer {
    draw(target: CanvasRenderingTarget2D, rendererOptions: PriceAxisViewRendererOptions, textWidthCache: TextWidthCache, width: number, align: 'left' | 'right'): void;
 ...
 */
export declare enum InteractionPhase {
 ...
 */
export declare enum FinalizationMethod {
