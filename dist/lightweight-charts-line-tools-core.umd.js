(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lightweight-charts')) :
    typeof define === 'function' && define.amd ? define(['exports', 'lightweight-charts'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.LightweightChartsLineToolsCore = {}, global.LightweightCharts));
})(this, (function (exports, lightweightCharts) { 'use strict';
     ...
     */
    exports.BoxVerticalAlignment = void 0;
    ...
    })(exports.BoxVerticalAlignment || (exports.BoxVerticalAlignment = {}));
    /**
     * Defines horizontal alignment options for box-like elements relative to a reference point.
     */
    exports.BoxHorizontalAlignment = void 0;
    ...
    })(exports.BoxHorizontalAlignment || (exports.BoxHorizontalAlignment = {}));
    /**
    ...
    })(exports.PaneCursorType || (exports.PaneCursorType = {}));
    /**
     ...
     */
    exports.InteractionPhase = void 0;
    ...
    })(exports.InteractionPhase || (exports.InteractionPhase = {}));
    /**
     ...
     */
    exports.FinalizationMethod = void 0;
    ...
    })(exports.FinalizationMethod || (exports.FinalizationMethod = {}));
     ...
     */
    const _dateStringCache = new Map();
    /**
    ...
    function interpolateTimeFromLogicalIndex(chart, series, logicalIndex) {
        ...
        // --- ZONE 3: THE BLANK SPACE (Verified Extrapolation) ---
            ...
            if (verifiedInterval === null || verifiedInterval === 0)
                return null;
            if (isFuture) {
    ...
    function getExtendedVisiblePriceRange(tool) {
        ...
        return {
            from: series.coordinateToPrice(paneHeight), // Bottom Price
            to: series.coordinateToPrice(0), // Top Price
        };
    }
    /**
        ...
        if (targetTimeNum >= firstTimeNum && targetTimeNum <= lastTimeNum) {
            ...
            while (low <= high) {
                ...
                if (midTimeNum === targetTimeNum) {
                    return mid; // Found an exact match during the search.
                }
    ...
    class InteractionManager {
        ...
        constructor(plugin, chart, series, tools, toolRegistry) {
            ...
            this._lastSnapLogical = null;
            this._lastSnapCandidates = [];
            /**
            ...
            this._boundHandleMouseDown = (event) => this._handleMouseDown(event);
            this._boundHandleMouseMove = (event) => this._handleMouseMove(event);
            this._boundHandleMouseUp = (event) => this._handleMouseUp(event);
            this._boundHandleMouseLeave = (event) => this._handleMouseLeave(event);
            this._boundHandleDblClick = (params) => this._handleDblClick(params);
            this._boundHandleCrosshairMove = (params) => this._handleCrosshairMove(params);
            this._boundHandleKeyDown = (event) => this._handleKey(event);
            this._boundHandleKeyUp = (event) => this._handleKey(event);
            this._plugin = plugin;
            this._chart = chart;
            this._series = series;
            this._tools = tools;
        ...
        _handleMouseDown(event) {
            ...
            if (hitResult && hitResult.tool) {
                ...
                let capturedCursor = hitResult.suggestedCursor || exports.PaneCursorType.Default;
                ...
                if (capturedCursor === exports.PaneCursorType.Pointer || capturedCursor === exports.PaneCursorType.Default) {
                    ...
                    capturedCursor = toolDragCursor || exports.PaneCursorType.Grabbing;
                }
                ...
                this._originalDragLogicalIndices = allOriginalPoints.map(p => interpolateLogicalIndexFromTime(this._chart, this._series, p.timestamp));
                // highlight-end
        ...
        _handleMouseMove(event) {
            ...
            if (this._isCreationGesture && this._creationTool && this._mouseDownPoint) {
                ...
                if (this._isDrag && isDragCreationSupported) {
                    ...
                    if (this._isShiftKeyDown && isShiftConstraintSupported) {
                        ...
                        const phase = exports.InteractionPhase.Creation;
            ...
            if (this._draggedTool && this._dragStartPoint) {
                ...
                if (this._isEditing) {
                    ...
                    const phase = isAnchorDrag ? exports.InteractionPhase.Editing : exports.InteractionPhase.Move;
        ...
        _handleMouseUp(event) {
            ...
            if (this._isCreationGesture && this._creationTool && this._mouseDownPoint) {
                ...
                if (finalizationMethod === exports.FinalizationMethod.MouseUp) {
                ...
                if (isDiscreteClick) {
                    ...
                    if (isShiftKeyDown && isShiftConstraintSupported) {
                        ...
                        if (originalLogicalPoint && tool.getShiftConstrainedPoint) {
                            ...
                            exports.InteractionPhase.Creation, originalLogicalPoint, // P0's original position
                    ...
                    if (finalizationMethod === exports.FinalizationMethod.PointCount && tool.isFinished()) {
                        this._finalizeToolCreation(tool);
                    ...
                    if (finalizationMethod === exports.FinalizationMethod.PointCount && tool.pointsCount === 2) {
        ...
        */
        ...
        _handleDblClick(params) {
            ...
            if (this._currentToolCreating) {
                ...
                if (tool.getFinalizationMethod() === exports.FinalizationMethod.DoubleClick) {
        ...
        _handleCrosshairMove(params) {
            ...
            if (toolBeingCreated) {
                ...
                if (toolBeingCreated.points().length > 0 && rawScreenPoint && isShiftKeyDown && toolBeingCreated.supportsShiftClickClickConstraint?.() === true) {
                    ...
                    const phase = exports.InteractionPhase.Creation; // Phase is Creation
        ...
        _isMouseInActivePane(y) {
            ...
            const myPane = layout.panes.find(p => p.series.indexOf(this._series) !== -1);
            if (!myPane)
                return true; // Fallback to true if unknown
    ...
    class TimeAxisViewRenderer {
        ...
        rendererOptions) {
            ...
            target.useMediaCoordinateSpace(({ context: ctx, mediaSize }) => {
                ...
                this._data.width; // Chart body width
     ...
     */
    class CrosshairTimeAxisLabelView {
        /**
    ...
    class LineToolsCorePlugin {
        ...
        constructor(chart, series, horzScaleBehavior) {
            ...
            this._selectSingleClickDelegate = new Delegate();
            // Throttled Stacking Update
            this._stackingUpdateScheduled = false;
            this._isDestroyed = false; // Flag to block logic after destruction
            this._chart = chart;
            this._series = series;
        ...
        getBarAtCoordinate(x) {
            ...
            timeScale.logicalToCoordinate(logical); // get timestamp if exists
        ...
        setCrossHairXY(x, y, visible, providedTime, providedPrice) {
            ...
            if (providedTime !== undefined && providedPrice !== undefined) {
                chart.setCrosshairPosition(providedPrice, providedTime, mainSeries);
            ...
            if (x !== null && y !== null) {
                ...
                if (lineToolPoint) {
                    const horizontalPosition = providedTime
                        ? providedTime
                        : lineToolPoint.timestamp;
                    chart.setCrosshairPosition(lineToolPoint.price, horizontalPosition, mainSeries);
                }
                else {
                    this.clearCrossHair();
                }
        ...
        */
        ...
        _createAndAddTool(type, points, options, id, initiateInteractive = false // New parameter to signal interactive drawing initiation
            ...
            const newTool = new ToolClass(this, this._chart, this._series, this._horzScaleBehavior, options, sanitizedPoints, // Pass sanitized array instead of raw points
        ...
        _findBarIndex(targetKey, mode) {
            ...
            while (low <= high) {
                ...
                if (midKey === targetKey)
                    return mid;
                if (midKey < targetKey) {
                    if (mode === 'floor' || mode === 'nearest')
                        lastValidIndex = mid;
                    low = mid + 1;
                }
                else {
                    if (mode === 'ceil' || mode === 'nearest')
                        lastValidIndex = mid;
                    high = mid - 1;
                }
            }
            if (mode === 'exact' || lastValidIndex === -1)
                return -1;
    ...
    function drawLine(ctx, x1, y1, x2, y2, style) {
        ...
        if (style !== lightweightCharts.LineStyle.Solid) {
    ...
    borderAlign, extendLeft, extendRight, containerWidth // The actual width of the drawing area.
        ...
        if (borderColor !== undefined && borderWidth > 0) {
            setLineStyle(ctx, borderStyle || lightweightCharts.LineStyle.Solid);
            let offsetLeft = 0;
            let offsetRight = 0;
            let offsetTop = 0;
            let offsetBottom = 0;
     ...
     */
    exports.cacheCanvas = null; // Changed to null initially
    /**
    ...
    function createCacheCanvas() {
        if (exports.cacheCanvas === null) { // Only create if it doesn't exist
            const canvas = document.createElement('canvas');
            // Set width/height to 0 to minimize memory footprint for a purely offscreen canvas
            canvas.width = 0;
            canvas.height = 0;
            exports.cacheCanvas = ensureNotNull(canvas.getContext('2d'));
        }
    }
    /**
    ...
    function textWrap(text, font, lineWrapWidth) {
        ...
        const ctx = ensureNotNull(exports.cacheCanvas); // Get the context
    ...
    })(exports.OffScreenState || (exports.OffScreenState = {}));
    // #endregion Types
    /**
    ...
    function getCullingStateWithExtensions(points, viewportBounds, extendOptions) {
        ...
        if (t_enter > t_exit) {
            ...
            if (toolBounds.minPrice > viewportBounds.maxPrice) {
                return exports.OffScreenState.OffScreenTop;
            }
            if (toolBounds.maxPrice < viewportBounds.minPrice) {
                return exports.OffScreenState.OffScreenBottom;
            }
            if (toolBounds.maxTime < viewportBounds.minTime) {
                return exports.OffScreenState.OffScreenLeft;
            }
            if (toolBounds.minTime > viewportBounds.maxTime) {
                return exports.OffScreenState.OffScreenRight;
            }
            return exports.OffScreenState.FullyOffScreen;
        }
        ...
        if (overlap_start <= overlap_end) {
            return exports.OffScreenState.Visible;
        }
    ...
    function getToolCullingState(points, tool, extendOptions, singlePointOrientation, cullingInfo, isAreaBased = false) {
        ...
        if (!viewportBounds) {
            return exports.OffScreenState.Visible; // Fail safe if viewport isn't available
        }
        ...
        if (isAreaBased) {
            ...
            if (toolBounds.maxPrice < viewportBounds.minPrice)
                return exports.OffScreenState.OffScreenBottom;
            if (toolMaxT < viewportBounds.minTime)
                return exports.OffScreenState.OffScreenLeft;
            if (toolMinT > viewportBounds.maxTime)
                return exports.OffScreenState.OffScreenRight;
            return exports.OffScreenState.FullyOffScreen;
        }
        ...
        if (points.length >= 3 && cullingInfo?.subSegments && extendOptions) {
            ...
            for (const [indexA, indexB] of cullingInfo.subSegments) {
                ...
                if (points[indexA] && points[indexB]) {
                    ...
                    if (callTwoPointCuller(points[indexA], points[indexB], extendOptions) === exports.OffScreenState.Visible) {
        ...
        if (points.length === 2) {
            ...
            if (!hasExtensions) {
                const toolBounds = getToolBoundingBox(points);
                if (!toolBounds)
                    return exports.OffScreenState.Visible; // Should not happen if points.length > 0
    ...
    class LineToolTimeAxisLabelView {
        ...
        _updateImpl() {
            ...
            const interpolatedLogicalIndex = interpolateLogicalIndexFromTime(this._chart, this._tool.getSeries(), timeAsHorzScaleItem);
    ...
    class BaseLineTool extends PriceDataSource {
        ...
        hitTest(x, y) {
            ...
            if (!this.options().editable) {
                ...
                if (internalResult !== null) {
                    ...
                    return {
                        externalId: this.id(),
                        zOrder: 'normal',
                        cursorStyle: this.options().notEditableCursor || exports.PaneCursorType.NotAllowed,
                    };
                }
            ...
            let cursorStyle = exports.PaneCursorType.Default;
            if (hitData?.suggestedCursor) {
                ...
                switch (internalResult.type()) {
                    case exports.HitTestType.MovePointBackground:
                        // Use tool's defaultDragCursor or a generic 'grabbing'
                        cursorStyle = options.defaultDragCursor || exports.PaneCursorType.Grabbing;
                        //console.log(`[BaseLineTool] Using defaultDragCursor: ${cursorStyle}`);
                        break;
                    case exports.HitTestType.MovePoint:
                    case exports.HitTestType.Regular:
                        // Use tool's defaultHoverCursor or a generic 'pointer'
                        cursorStyle = options.defaultHoverCursor || exports.PaneCursorType.Pointer;
                        //console.log(`[BaseLineTool] Using defaultHoverCursor: ${cursorStyle}`);
                        break;
                    case exports.HitTestType.ChangePoint:
                        // For anchor points, a generic resize cursor if not specifically set elsewhere
                        cursorStyle = exports.PaneCursorType.DiagonalNwSeResize; // Example, can be refined.
                        //console.log(`[BaseLineTool] Using generic DiagonalNwSeResize for ChangePoint.`);
                        break;
                    default:
                        cursorStyle = exports.PaneCursorType.Default;
         ...
         */
        isCulled() { return this._isCulled; }
        /**
        ...
        getFinalizationMethod() {
            return exports.FinalizationMethod.PointCount;
        }
        /**
        ...
        hitTest(x, y) {
            ...
            for (let i = 0; i < this._data.points.length; ++i) {
                ...
                if (distance <= hitThreshold) {
                    ...
                    let suggestedCursor = exports.PaneCursorType.Default;
                    ...
                    else if (this._data.hitTestType === exports.HitTestType.ChangePoint) {
                        suggestedCursor = exports.PaneCursorType.DiagonalNwSeResize;
                    }
                    // Priority 4: Generic pointer fallback
                    else {
                        suggestedCursor = exports.PaneCursorType.Pointer;
                    }
    ...
    function drawRect(ctx, point, radius, lineWidth) {
        ...
        drawRoundRect(ctx, point.x - n, point.y - n, 2 * n, 2 * n, (radius + lineWidth) / 2, lightweightCharts.LineStyle.Solid);
        ctx.closePath();
    }
    /**
    ...
    class SegmentRenderer {
        ...
        constructor(hitTest) {
            ...
            this._hitTest = hitTest || new HitTestResult(exports.HitTestType.MovePoint);
        }
        /**
        ...
        draw(target) {
            ...
            target.useMediaCoordinateSpace(({ context: ctx, mediaSize }) => {
                ...
                const lineStyle = line.style || lightweightCharts.LineStyle.Solid;
        ...
        hitTest(x, y) {
            ...
            if (extendedClippedSegment instanceof Point) {
                if (extendedClippedSegment.subtract(new Point(x, y)).length() <= interactionTolerance.line) {
                    const suggestedCursor = toolDefaultHoverCursor || exports.PaneCursorType.Pointer;
        ...
        _drawEnds(ctx, points, width, style) {
            ...
            if (lineOptions.end?.left === exports.LineEnd.Arrow) {
                drawArrowEnd(points[1], points[0], ctx, width, style);
            }
            else if (lineOptions.end?.left === exports.LineEnd.Circle) {
                drawCircleEnd(points[0], ctx, width);
            }
            if (lineOptions.end?.right === exports.LineEnd.Arrow) {
                drawArrowEnd(points[0], points[1], ctx, width, style);
            }
            else if (lineOptions.end?.right === exports.LineEnd.Circle) {
    ...
    class PolygonRenderer {
        ...
        draw(target) {
            ...
            target.useMediaCoordinateSpace(({ context: ctx, mediaSize }) => {
                ...
                setLineStyle(ctx, line.style || lightweightCharts.LineStyle.Solid); // Apply lineStyle
                ...
                if (pointsCount >= 2) {
                    ...
                    else if (line.end?.left === exports.LineEnd.Circle) {
        ...
        hitTest(x, y) {
            ...
            for (let i = 1; i < points.length; i++) {
                if (distanceToSegment(points[i - 1], points[i], point).distance <= interactionTolerance.line) {
                    const suggestedCursor = toolDefaultHoverCursor || exports.PaneCursorType.Pointer;
                    return new HitTestResult(exports.HitTestType.MovePoint, { pointIndex: null, suggestedCursor });
                }
            }
            ...
            if (hitTestBackground && background?.color && points.length > 2 && pointInPolygon(point, points)) {
                const suggestedCursor = toolDefaultDragCursor || exports.PaneCursorType.Grabbing;
                return new HitTestResult(exports.HitTestType.MovePointBackground, { pointIndex: null, suggestedCursor });
            }
            return null;
        }
    }
    ...
    class RectangleRenderer {
        ...
        draw(target) {
            ...
            target.useMediaCoordinateSpace(({ context: ctx, mediaSize }) => {
                ...
                const borderStyle = border?.style || lightweightCharts.LineStyle.Solid;
        ...
        hitTest(x, y) {
            ...
            // Hit-testing the actual segments of the rectangle's border
            const suggestedHoverCursor = toolDefaultHoverCursor || exports.PaneCursorType.Pointer;
            ...
            if (distanceToSegment(htTopLeft, htTopRight, clickedPoint).distance <= lineTolerance) {
                ...
                return new HitTestResult(exports.HitTestType.MovePoint, { pointIndex: null, suggestedCursor: suggestedHoverCursor });
            }
            ...
            if (hitTestBackground && pointInBox(clickedPoint, new Box(topLeft, bottomRight))) {
                const suggestedDragCursor = toolDefaultDragCursor || exports.PaneCursorType.Grabbing;
                //console.log(`[RectangleRenderer] *** HIT DETECTED on background! Suggesting cursor: ${suggestedDragCursor}`);
                return new HitTestResult(exports.HitTestType.MovePointBackground, { pointIndex: null, suggestedCursor: suggestedDragCursor });
            }
            return null;
        }
    }
    ...
    class TextRenderer {
        ...
        draw(target) {
            ...
            target.useMediaCoordinateSpace(({ context: ctx, mediaSize }) => {
                ...
                const boxBorderStyle = textData.box?.border?.style || lightweightCharts.LineStyle.Solid;
                ...
                let canvasAlign;
                if (alignValue === exports.TextAlignment.Center) {
                    canvasAlign = 'center';
                }
                else if (alignValue === exports.TextAlignment.End || alignValue === exports.TextAlignment.Right) {
                    canvasAlign = 'right';
                }
        ...
        _getInternalData() {
            ...
            if (!data.points || data.points.length < 2 || isDegenerate) {
                ...
                let textAlign = exports.TextAlignment.Start;
                switch (rawAlignment) {
                    case exports.TextAlignment.Start:
                    case exports.TextAlignment.Left: {
                        // FIX: Always assign TextAlignment.Start to maintain clean enum value.
                        textAlign = exports.TextAlignment.Start;
                        ...
                        if (isRtl()) {
                            if (data.text?.forceTextAlign) {
                                ...
                                textAlign = exports.TextAlignment.End;
                            }
                        }
                        break;
                    }
                    case exports.TextAlignment.Center: {
                        ...
                        textAlign = exports.TextAlignment.Center;
                        textStart = boxWidth / 2;
                        break;
                    }
                    case exports.TextAlignment.End:
            ...
            switch ((data.text?.box?.alignment?.horizontal || '').toLowerCase()) {
                case exports.BoxHorizontalAlignment.Left:
                    refX = rectMinX;
                    break;
                case exports.BoxHorizontalAlignment.Center:
                    refX = (rectMinX + rectMaxX) / 2;
                    break;
                case exports.BoxHorizontalAlignment.Right:
                    refX = rectMaxX;
                    break;
            }
            switch ((data.text?.box?.alignment?.vertical || '').toLowerCase()) {
                case exports.BoxVerticalAlignment.Top:
                    refY = rectMinY;
                    break;
                case exports.BoxVerticalAlignment.Middle:
                    refY = (rectMinY + rectMaxY) / 2;
                    break;
                case exports.BoxVerticalAlignment.Bottom:
                    refY = rectMaxY;
                    break;
            }
        ...
        _getLinesMaxWidth(lines) {
            ...
            createCacheCanvas();
            const ctx = ensureNotNull(exports.cacheCanvas);
        ...
        draw(target) {
            ...
            target.useMediaCoordinateSpace(({ context: ctx, mediaSize }) => {
                ...
                if (border?.width && border.width > 0 && border.color) {
                    ...
                    setLineStyle(ctx, border.style || lightweightCharts.LineStyle.Solid); // Apply line style
                    ctx.beginPath();
                    ctx.arc(centerX, centerY, radius, 0, 2 * Math.PI);
                    ctx.stroke();
                }
    ...
    class LineToolPaneView {
        ...
        createLineAnchor(data, index) {
            ...
            renderer.setData({
                ...
                hitTestType: exports.HitTestType.ChangePoint, // Default hit test type for anchors
            });
            return renderer;
        }
        /**
    ...
    exports.BaseLineTool = BaseLineTool;
    exports.Box = Box;
    exports.CircleRenderer = CircleRenderer;
    exports.CompositeRenderer = CompositeRenderer;
    exports.DataSource = DataSource;
    exports.Delegate = Delegate;
    exports.HalfPlane = HalfPlane;
    exports.HitTestResult = HitTestResult;
    exports.InteractionManager = InteractionManager;
    exports.LineAnchorRenderer = LineAnchorRenderer;
    exports.LineToolPaneView = LineToolPaneView;
    exports.LineToolsCorePlugin = LineToolsCorePlugin;
    exports.MINIMUM_PADDING_PIXELS = MINIMUM_PADDING_PIXELS;
    exports.Point = Point;
    exports.PolygonRenderer = PolygonRenderer;
    exports.PriceAxisLabelStackingManager = PriceAxisLabelStackingManager;
    ...
    exports.clipPolygonToViewport = clipPolygonToViewport;
    exports.computeDashPattern = computeDashPattern;
    exports.computeEndLineSize = computeEndLineSize;
    exports.convertDateStringToUTCTimestamp = convertDateStringToUTCTimestamp;
    exports.convertUTCTimestampToDateString = convertUTCTimestampToDateString;
    exports.createCacheCanvas = createCacheCanvas;
    exports.createLineToolsPlugin = createLineToolsPlugin;
    ...
    exports.drawArrowEnd = drawArrowEnd;
    exports.drawCircleEnd = drawCircleEnd;
    ...
    exports.drawSolidLine = drawSolidLine;
    exports.drawVerticalLine = drawVerticalLine;
    exports.ensureDefined = ensureDefined;
    exports.ensureNotNull = ensureNotNull;
    exports.equalBoxes = equalBoxes;
    exports.equalPoints = equalPoints;
    exports.extendAndClipLineSegment = extendAndClipLineSegment;
    exports.fillRectWithBorder = fillRectWithBorder;
    exports.generateContrastColors = generateContrastColors;
    exports.getArrowPoints = getArrowPoints;
    exports.getBoxHeight = getBoxHeight;
    exports.getBoxWidth = getBoxWidth;
    exports.getCullingStateWithExtensions = getCullingStateWithExtensions;
    exports.getExtendedVisiblePriceRange = getExtendedVisiblePriceRange;
    exports.getFontAwareScale = getFontAwareScale;
    exports.getFontSize = getFontSize;
    exports.getScaledBackgroundInflationX = getScaledBackgroundInflationX;
    exports.getScaledBackgroundInflationY = getScaledBackgroundInflationY;
    exports.getScaledBoxPaddingX = getScaledBoxPaddingX;
    exports.getScaledBoxPaddingY = getScaledBoxPaddingY;
    exports.getScaledFontSize = getScaledFontSize;
    exports.getScaledPadding = getScaledPadding;
    exports.getToolBoundingBox = getToolBoundingBox;
    exports.getToolCullingState = getToolCullingState;
    exports.getViewportBounds = getViewportBounds;
    exports.halfPlaneThroughPoint = halfPlaneThroughPoint;
    exports.interpolateLogicalIndexFromTime = interpolateLogicalIndexFromTime;
    exports.interpolateTimeFromLogicalIndex = interpolateTimeFromLogicalIndex;
    exports.intersectLineAndBox = intersectLineAndBox;
    exports.intersectLineSegmentAndBox = intersectLineSegmentAndBox;
    exports.intersectLineSegments = intersectLineSegments;
    exports.intersectLines = intersectLines;
    exports.intersectPolygonAndHalfPlane = intersectPolygonAndHalfPlane;
    exports.intersectRayAndBox = intersectRayAndBox;
    exports.isBoolean = isBoolean;
    exports.isFullyTransparent = isFullyTransparent;
    ...
    exports.logicalIndexToCoordinate = logicalIndexToCoordinate;
    ...
    exports.roundPriceToStep = roundPriceToStep;
    exports.setLineDash = setLineDash;
    exports.setLineStyle = setLineStyle;
    exports.textWrap = textWrap;

}));
//# sourceMappingURL=lightweight-charts-line-tools-core.umd.js.map
